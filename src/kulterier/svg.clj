(ns kulterier.svg
  "Contains functions producing inline SVGs as Hiccup.")

(defn magnifying-glass [& {:keys [height width color class alt]}]
  [:svg
   {"xml:space" "preserve"
    :viewBox "0 0 512 512"
...
(defn kulterier-logo
  ([& {:keys [width height id class alt]}]
   [:svg
    {:id id
     :class class
     :alt alt
